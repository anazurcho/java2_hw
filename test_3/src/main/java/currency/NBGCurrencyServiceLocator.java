...
public class NBGCurrencyServiceLocator extends org.apache.axis.client.Service implements currency.NBGCurrencyService {
    ...
    public currency.NBGCurrencyPort_PortType getNBGCurrencyPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            currency.NBGCurrencyBindingStub _stub = new currency.NBGCurrencyBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (currency.NBGCurrencyPort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                currency.NBGCurrencyBindingStub _stub = new currency.NBGCurrencyBindingStub(new java.net.URL(NBGCurrencyPort_address), this);
                _stub.setPortName(getNBGCurrencyPortWSDDServiceName());
                return _stub;
            }
        }
